...
namespace BookBlossom.Infrastructure.Migrations
{
    ...
    [Migration("20260606171616_AddAdminReplyToReview")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.Author", b =>
                {
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.BlindBookImage", b =>
                {
                    ...
                    b.ToTable("BlindBookImages", "Book");
                });

            modelBuilder.Entity("BookBlossom.Core.Entities.BookAuthor", b =>
                {
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.BookImage", b =>
                {
                    b.Property<long>("ImageID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.CallRequest", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("CallRequestID"));
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.MessageAttachment", b =>
                {
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.OrderDetail", b =>
                {
                    ...
                    b.Property<string>("VoucherBreakdown")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.OrderVoucher", b =>
                {
                    b.Property<long>("OrderID")
                        .HasColumnType("bigint")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.Review", b =>
                {
                    ...
                    b.Property<string>("AdminReplyContent")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsTransferredToStore")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.ReviewLike", b =>
                {
                    b.Property<long>("ReviewID")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ReviewLike", "Review");
                });

            modelBuilder.Entity("BookBlossom.Core.Entities.ReviewMedia", b =>
                {
                    ...
                    b.ToTable("ReviewMedia", "Review");
                });

            modelBuilder.Entity("BookBlossom.Core.Entities.ReviewReport", b =>
                {
                    b.Property<long>("ReportID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.ThreadLike", b =>
                {
                    b.Property<long>("PostID")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.ThreadShare", b =>
                {
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.VoucherBook", b =>
                {
                    b.Property<long>("VoucherID")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("VoucherID", "BookID");

                    b.HasIndex("BookID");

                    b.ToTable("VoucherBook", "Voucher");
                });
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.BookAuthor", b =>
                {
                    b.HasOne("BookBlossom.Core.Entities.Author", "Author")
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.CallRequest", b =>
                {
                    b.HasOne("BookBlossom.Core.Entities.CustomerDetail", "Buyer")
                        .WithMany()
                    ...
                    b.HasOne("BookBlossom.Core.Entities.User", "Resolver")
                        .WithMany()
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.MessageAttachment", b =>
                {
                    b.HasOne("BookBlossom.Core.Entities.Message", "Message")
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.Review", b =>
                {
                    ...
                    b.HasOne("BookBlossom.Core.Entities.Order", "Orders")
                        .WithMany("Reviews")
                        .HasForeignKey("OrderID")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.ReviewLike", b =>
                {
                    ...
                    b.HasOne("BookBlossom.Core.Entities.Review", "Review")
            ...
            modelBuilder.Entity("BookBlossom.Core.Entities.ReviewReport", b =>
                {
                    b.HasOne("BookBlossom.Core.Entities.CustomerDetail", "Reporter")
                        .WithMany()
